...
class IterativeRefinementGenerator(object):
    ...
    def generate(self, models, sample, prefix_tokens=None):
        ...
        for step in range(self.max_iter + 1):
            ...
            if decoder_out.terminated is not None:
                terminated = decoder_out.terminated
            elif self.adaptive:
            ...
            prev_decoder_out = decoder_out._replace(
                ...
                terminated=decoder_out.terminated[not_terminated] if decoder_out.terminated is not None else None,
