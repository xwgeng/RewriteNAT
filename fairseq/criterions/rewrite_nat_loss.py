...
@register_criterion("rewrite_nat_loss")
class RewriteLabelSmoothedDualImitationCriterion(FairseqCriterion):
    @staticmethod
    def add_args(parser):
    ...
    def forward(self, model, sample, reduce=True):
        ...
        if outputs["discriminator"] is not None:
            for k, v in enumerate(outputs["discriminator"]["acc"]):
                logging_output["discriminator-acc" + str(k)] = utils.item(v.data)
